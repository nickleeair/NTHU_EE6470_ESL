...
const int MEAN_MM_BASE = 0x90000000;
const int MEAN_MM_SIZE = 0x0000000C;
const int MEAN_MM_MASK = 0x0000000F;

const int MEDIAN_MM_BASE = 0x80000000;
const int MEDIAN_MM_SIZE = 0x00050000;
const int MEDIAN_MM_MASK = 0x00000400;
