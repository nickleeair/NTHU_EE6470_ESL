...
define_hls_module DecimationFilter ../softmax.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config DecimationFilter BASIC
define_hls_config DecimationFilter DPA       --dpopt_auto=op,expr
define_hls_config DecimationFilter UNROLL    --dpopt_auto=op,expr
define_hls_config DecimationFilter PIPELINE    --dpopt_auto=op,expr
define_hls_config DecimationFilter LATENCY    --dpopt_auto=op,expr
define_hls_config DecimationFilter UNROLL_PIPE    --dpopt_auto=op,expr
define_hls_config DecimationFilter LATENCY_PIPE    --dpopt_auto=op,expr
...
define_sim_config V_BASIC "DecimationFilter RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "DecimationFilter RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.4  
define_sim_config V_UNROLL "DecimationFilter RTL_V UNROLL" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.5  
define_sim_config V_PIPELINE "DecimationFilter RTL_V PIPELINE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.6 
define_sim_config V_LATENCY "DecimationFilter RTL_V LATENCY" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.7  
define_sim_config V_UNROLL_PIPE  "DecimationFilter RTL_V UNROLL_PIPE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.8  
define_sim_config V_LATENCY_PIPE  "DecimationFilter RTL_V LATENCY_PIPE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
