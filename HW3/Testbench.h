...
public:
	...
	cynw_p2p<sc_dt::sc_uint<32> >::base_in ir_result;
  cynw_p2p<sc_dt::sc_uint<32> >::base_in ig_result;
  cynw_p2p<sc_dt::sc_uint<32> >::base_in ib_result;
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgb;
	sc_fifo_in<sc_dt::sc_uint<32> > ir_result;
  sc_fifo_in<sc_dt::sc_uint<32> > ig_result;
  sc_fifo_in<sc_dt::sc_uint<32> > ib_result;
#endif
