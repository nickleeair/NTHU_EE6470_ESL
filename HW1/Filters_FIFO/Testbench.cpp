      ...
      //std::cout<<"filter_result input"<<endl; 
        ...
        continue;
          ...
          if (ir_result.num_available() == 0)
                  ...
                  //std::cout<<"filter_result input"<<endl;  
                  *(target_bitmap + bytes_per_pixel * (width * y + x) + 2) = ir_result.read();
                  //std::cout<<"ir_filter_result input= "<<ir_result.read()<<endl; 
                  *(target_bitmap + bytes_per_pixel * (width * y + x) + 1) = ig_result.read();
                  //std::cout<<"ig_filter_result input"<<endl;
                  *(target_bitmap + bytes_per_pixel * (width * y + x) + 0) = ib_result.read();
                  //std::cout<<"ib_filter_result input"<<endl;
        } 
    }
  }
